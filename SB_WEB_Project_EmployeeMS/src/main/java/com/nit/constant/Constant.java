...
public class Constant {
	...
	//URLs
	public static final String INDEX_URL="/ems";
	public static final String INDEX_VIEW="index";
	
	public static final String HOME_URL="/home";
	public static final String HOME_VIEW="home";
	
	public static final String SAVE_URL="/saveEmployee";
	public static final String REDIRECT_HOME="redirect:/home";
	public static final String DELETE_URL ="/deleteEmployee";
	public static final String EDIT_URL ="/editEmployee";
	public static final String EDIT_VIEW ="update";
	public static final String UPDATE_URL ="/updateEmployee";
